...
// ok so here is the majority of the js code. I used some stuff that I found online but followed 
// a pretty basic approach. Set up functions that listen for events and and then create functions that 
//act on the choices the player makes with conditionals. I didn't add any of the images or sounds to hte 
// code, cause I am still struggling with just trying to make the code work. 


//BAsic document.ready function looking for events in the document
$(document).ready(function() {

//attaching the code needed to get started
